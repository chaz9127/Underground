...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: {
    ...
    icon: { type: String },
    callback: { type: Function, default: function _default() {
        return 'unset';
      } }
  },
  data: function data() {
  ...
  methods: {
    goTo: function goTo(name, context) {
      ...
      if (this.callback() === unset) {
        var result = new Promise(function (resolve) {
          return _this.$emit('callback');
        });

        result.then(function (value) {
          return console.log('this ok?');
        });
      } else {}
    }
  },
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-295e7b55fcec069471bb.js.map