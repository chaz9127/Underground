...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: {
    ...
    icon: { type: String },
    callthis: { type: Function, default: function _default() {
        return 'unset';
      } }
  },
  data: function data() {
    ...
    _c(
      ...
      [
        _c("nav-button", {
          ...
          on: { callthis: _vm.setNewCustomerType }
        })
      ],
      1
    ),
    ...
    _c(
      ...
      [
        _c("nav-button", {
          ...
          on: { callthis: _vm.setReturningCustomerType }
        })
      ],
      1
    )
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-a42b90264780e7e880cc.js.map