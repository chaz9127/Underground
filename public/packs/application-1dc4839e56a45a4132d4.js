...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: ['routeName', 'routeContext', 'buttonText', 'icon', 'callback'],
  data: function data() {
    return {};
  },
  methods: {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    setCustomerType: function setCustomerType() {
      __WEBPACK_IMPORTED_MODULE_1__stores_event_store_js__["a" /* default */].methods.setCustomerType();
    }
  },
  components: { NavButton: __WEBPACK_IMPORTED_MODULE_0__components_nav_button_vue__["a" /* default */] }
});
    ...
    _c(
      ...
      [
        _c("nav-button", {
          ...
          on: { callback: _vm.setCustomerType }
        })
      ],
      1
    ),
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-1dc4839e56a45a4132d4.js.map